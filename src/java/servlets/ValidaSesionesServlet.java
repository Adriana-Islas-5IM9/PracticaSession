...
public class ValidaSesionesServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            miDB = new ConectaDB();
            miDB.conecta();
            ResultSet res = miDB.query("select * from Usuario where user='" + usSesion + "' and password='" + claveSesion + "';");
        ...
        /** Parte del código modificada:
         * if (claveSesion.equals("emmanueloropeza")) { titulo = "llave correcta
         * continua la sesion"; } else { titulo = "llave incorrecta inicie
         * nuevamente sesion";
        }**/
